...
export default function Stats() {
  ...
  const stats = [
    { value: '10K+', label: t('stats.downloads'), icon: '📲', color: '#E53935' },
    ...
    <section id="stats" className="section stats">
      <div className="container">
        ...
        <div className="stats__grid">
          {stats.map((s, i) => (
            <div key={i} className={`stats-card animate-fade-in-up animate-delay-${i + 1}`}>
        ...
        <div className="stats__tech">
          ...
          <div className="stats__tech-pills">
            {['Flutter', 'Dart', 'Drift (SQLite)', 'Riverpod', 'fl_chart', 'Google Fonts', 'AdMob'].map(t => (
              <span key={t} className="stats__pill">{t}</span>
            ))}
          </div>
        </div>
      </div>
